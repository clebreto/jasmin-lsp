...
def test_initialization(client: LSPClient, results: TestResults):
    """Test server initialization"""
    response = client.initialize(file_uri("."))
...
def test_diagnostics(client: LSPClient, results: TestResults, test_file: str):
...
def test_goto_definition(client: LSPClient, results: TestResults, test_file: str):
...
def test_find_references(client: LSPClient, results: TestResults, test_file: str):
...
def test_hover(client: LSPClient, results: TestResults, test_file: str):
...
def test_document_change(client: LSPClient, results: TestResults, test_file: str):
...
def test_document_close(client: LSPClient, results: TestResults, test_file: str):
