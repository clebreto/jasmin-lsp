...
let get_namespace_paths state = !(state.namespace_paths)

let set_namespace_paths state paths = 
  state.namespace_paths := paths;
  Io.Logger.log (Format.asprintf "Namespace paths set: %d namespaces" (List.length paths))
